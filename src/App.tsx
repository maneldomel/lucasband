...
const defaultCustomizationData: CustomizationData = {
  ...
  audioWarningSubtitle: "Simple kitchen ritual reverses years of impotence.",
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          {/* Headline */}
          <h1 className="text-4xl md:text-5xl font-black text-red-800 text-center mb-8 leading-tight">
          ...
          {/* Audio warning */}
          <div className="flex items-center justify-center mt-4 text-red-900">
